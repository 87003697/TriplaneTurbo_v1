...
#include <stdio.h>
#include <cmath>
#include <cfloat> // Required for FLT_MAX (or use numeric_limits if preferred)
#include <limits> // Or include this for numeric_limits
...
// ****** KERNEL IMPLEMENTATIONS MOVED TO rasterizer_impl.cu ******

// ****** END MOVED KERNEL IMPLEMENTATION ******
