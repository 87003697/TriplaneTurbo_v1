...
@dataclass
class MultiviewMultipromptMultiStepSceneDataModuleConfig:
...
class BaseDataset(Dataset, Updateable):
    def __init__(
        ...
        super().__init__()
        self.cfg: MultiviewMultipromptMultiStepSceneDataModuleConfig = cfg        
        ##############################################################################################################
...
@register("multiview-multiprompt-multistep-datamodule-scene")
class MultiviewMultipromptMultiStepSceneDataModule(pl.LightningDataModule):
    cfg: MultiviewMultipromptMultiStepSceneDataModuleConfig

    def __init__(self, cfg: Optional[Union[dict, DictConfig]] = None) -> None:
        super().__init__()
        self.cfg = parse_structured(MultiviewMultipromptMultiStepSceneDataModuleConfig, cfg)
        ##############################################################################################################
